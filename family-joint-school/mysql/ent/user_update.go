...
func (uu *UserUpdate) SetNillableExtra(s *string) *UserUpdate {
	if s != nil {
		uu.SetExtra(*s)
	}
	return uu
...
func (uu *UserUpdate) SetClassID(u uint8) *UserUpdate {
	uu.mutation.ResetClassID()
	uu.mutation.SetClassID(u)
	return uu
}

// SetNillableClassID sets the "class_id" field if the given value is not nil.
func (uu *UserUpdate) SetNillableClassID(u *uint8) *UserUpdate {
	if u != nil {
		uu.SetClassID(*u)
	}
	return uu
...
func (uu *UserUpdate) AddClassID(u int8) *UserUpdate {
	uu.mutation.AddClassID(u)
	return uu
}

// ClearClassID clears the value of the "class_id" field.
func (uu *UserUpdate) ClearClassID() *UserUpdate {
	uu.mutation.ClearClassID()
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.ClassID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
	...
	if value, ok := uu.mutation.AddedClassID(); ok {
...
// SetNillableExtra sets the "extra" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableExtra(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetExtra(*s)
	}
	return uuo
...
// SetClassID sets the "class_id" field.
func (uuo *UserUpdateOne) SetClassID(u uint8) *UserUpdateOne {
	uuo.mutation.ResetClassID()
	uuo.mutation.SetClassID(u)
	return uuo
}

// SetNillableClassID sets the "class_id" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableClassID(u *uint8) *UserUpdateOne {
	if u != nil {
		uuo.SetClassID(*u)
	}
	return uuo
...
// AddClassID adds u to the "class_id" field.
func (uuo *UserUpdateOne) AddClassID(u int8) *UserUpdateOne {
	uuo.mutation.AddClassID(u)
	return uuo
}

// ClearClassID clears the value of the "class_id" field.
func (uuo *UserUpdateOne) ClearClassID() *UserUpdateOne {
	uuo.mutation.ClearClassID()
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.ClassID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint8,
			Value:  value,
			Column: user.FieldClassID,
	...
	if value, ok := uuo.mutation.AddedClassID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint8,
			Value:  value,
			Column: user.FieldClassID,
	...
	if uuo.mutation.ClassIDCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeUint8,
			Column: user.FieldClassID,
		})
