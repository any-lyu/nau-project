...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldClassID:
			values[i] = new(sql.NullInt64)
		case user.FieldNickname, user.FieldAvatar, user.FieldMobile, user.FieldExtra:
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.ClassID))
	builder.WriteString(", ")
