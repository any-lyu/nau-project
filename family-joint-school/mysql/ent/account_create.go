...
func (ac *AccountCreate) SetNillableUserID(u *uint64) *AccountCreate {
	if u != nil {
		ac.SetUserID(*u)
	}
	return ac
...
func (ac *AccountCreate) SetPermission(u uint8) *AccountCreate {
	ac.mutation.SetPermission(u)
	return ac
}

// SetNillablePermission sets the "permission" field if the given value is not nil.
func (ac *AccountCreate) SetNillablePermission(u *uint8) *AccountCreate {
	if u != nil {
		ac.SetPermission(*u)
	}
	return ac
